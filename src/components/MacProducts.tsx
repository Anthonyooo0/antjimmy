  ...
  return (
    <section id="mac-products" className="py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#1e3a8a' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-12 grid-rows-auto gap-0">

          {/* Box 1 - video_mac.mp4 (Large, spans 7 cols, 2 rows) */}
          <div className="col-span-12 md:col-span-7 row-span-2 bg-white/10 border-2 border-dashed border-white/40 rounded-none min-h-[300px] md:min-h-[400px] flex items-center justify-center">
          ...
          <div className="col-span-12 md:col-span-5 row-span-2 bg-white/10 border-2 border-dashed border-white/40 rounded-none p-6 flex flex-col justify-center">
          ...
          <div className="col-span-6 md:col-span-4 row-span-2 bg-white/10 border-2 border-dashed border-white/40 rounded-none min-h-[350px] flex items-center justify-center">
            <div className="text-center">
          ...
          <div className="col-span-6 md:col-span-8 row-span-2 bg-white/10 border-2 border-dashed border-white/40 rounded-none min-h-[350px] flex items-center justify-center">
            <div className="text-center">
          ...
          <div className="col-span-12 md:col-span-6 row-span-2 bg-white/10 border-2 border-dashed border-white/40 rounded-none min-h-[350px] flex items-center justify-center">
            <div className="text-center">
          ...
          <div className="col-span-12 bg-white/10 border-2 border-dashed border-white/40 rounded-none p-6 min-h-[120px] flex items-center justify-center">
            <div className="text-center">
